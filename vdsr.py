...
class Conv_ReLU_Block2(nn.Module):
    def __init__(self, Cn=32):
        super(Conv_ReLU_Block2, self).__init__()
...
class NetF13(nn.Module):
    def __init__(self):
        super(NetF13, self).__init__()
        self.Cn = 13
        self.residual_layer = self.make_layer(Conv_ReLU_Block2, 18)
